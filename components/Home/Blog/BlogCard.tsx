...
const BlogCard = ({image,title}:Blog) => {
  return (
    <div className=''>
      <Image 
       src={image}
       ...
       <h2 className="mt-5 text-lg sm:text-xl font-bold  text-white hover:underline 
       ...
       <div className="mt-4 flex gap-2 items-center">
        ...
        <p className="px-4 py-1.5 bg-blue-950 text-white 
