    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <button
          data-aos="fade-up"
          data-aos-delay="600"
          className="mt-6 px-10 py-2 bg-blue-800 hover:bg-blue-900 transition-all duration-300 cursor-pointer rounded-full text-lg font-medium flex items-center gap-2"
        >
